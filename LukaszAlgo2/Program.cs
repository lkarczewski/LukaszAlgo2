...
namespace LukaszAlgo2
{
    class Program
    {
        ...
        {
            Test t1 = new Test();
            t1.GaussWithoutPivotTest(100,50);

            //MyMatrix<double> macierzDouble1 = new MyMatrix<double>(100,100);
            //MyMatrix<double> _macierzDouble1 = new MyMatrix<double>(100,100);
            ...
            //macierzDouble1.PrintMatrix();
            //Console.WriteLine("\n");
            //_macierzDouble1.PrintMatrix();

            //for (var i = 0; i < macierzDouble1.Rows(); i++)
            //{
            //    for (var j =0; j < macierzDouble1.Columns(); j++)
            //    {
            //        _macierzDouble1[i, j] = macierzDouble1[i,j];
            //    }
            //}
            //Console.WriteLine("\n");
            //macierzDouble1.PrintMatrix();
