...
namespace LukaszAlgo2
{
    class Test
    {
        ...
        public void GaussWithoutPivotTimeTest(int size, int count)
        {
            ...
            if (writer != null)
            {
                writer.WriteLine(String.Format(size + "x" + size + ";" + sredniaFloat + ";" + sredniaDouble));
            }
            writer.Close();
            ...
            //if (writer != null)
            //{
            //    writer.WriteLine(String.Format(size + "x" + size + ";" + sredniaUlamek));
            //}
            //writer.Close();
        ...
        public void GaussPartialPivotTimeTest(int size, int count)
        {
            ...
            if (writer != null)
            {
                writer.WriteLine(String.Format(size + ";" + sredniaFloat + ";" + sredniaDouble));
            }
            writer.Close();
        ...
        public void GaussWithoutPivotAccuracyTest(int size, int count)
        {
            ...
            if (writer != null)
            {
                writer.WriteLine(String.Format(size + "x" + size + ";" + sredniaNormaDouble + ";" + sredniaNormaFloat));
            }
            writer.Close();
        ...
        public void GaussPartialPivotAccuracyTest(int size, int count)
        {
            ...
            Console.WriteLine("GAUSS PARTIAL PIVOT: " + size);
            Console.WriteLine("Średnia norma double: " + sredniaNormaDouble);
            Console.WriteLine("Średnia norma float: " + sredniaNormaFloat);
        }
        ...
        public void GaussFullPivotAccuracyTest(int size, int count)
        {
            ...
            Console.WriteLine("GAUSS FULL PIVOT: " + size);
            Console.WriteLine("Średnia norma double: " + sredniaNormaDouble);
            Console.WriteLine("Średnia norma float: " + sredniaNormaFloat);
        }
    }
